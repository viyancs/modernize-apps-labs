...
public class CatalogEndpointTest {
    ...
    public void test_retriving_one_proudct() {
        ResponseEntity<Product> response = restTemplate.getForEntity("/services/product/329199", Product.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).returns("329199", Product::getItemId)
    ...
    public void check_that_endpoint_returns_a_correct_list() {
        ...
        ResponseEntity<List<Product>> rateResponse = restTemplate.exchange("/services/products", HttpMethod.GET, null,
        ...
        assertThat(fedora).returns("329299", Product::getItemId).returns("Red Fedora", Product::getName)
                .returns(9999,Product::getQuantity)
